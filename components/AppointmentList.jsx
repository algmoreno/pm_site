            ...
            >
              ...
              <div className="mt-5 sm:mt-6 sm:grid sm:grid-flow-row-dense sm:grid-cols-2 sm:gap-3">
                <button
                  ...
                  className={`${isWithin24Hours ? 'bg-gray-200 hover:cursor-default' : 'bg-red-700 hover:bg-red-600 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-red-600'} mt-3 inline-flex w-full justify-center rounded-md px-3 py-2 text-sm font-semibold text-white shadow-2xs  sm:col-start-2`}>
                  Delete
                </button>
                <button
                  type="button"
