...
export async function POST(req){
  try {
    await mongoClient(); 
    const { userId, startDatetime, endDatetime, price, service } = await req.json();
    ...
    const newAppointment = await Appointment.create({ user: userId, startDatetime, endDatetime, price, service }); 
